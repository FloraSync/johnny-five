...
![docs/breadboard/kinect-arm-controller.png](breadboard/kinect-arm-controller.png)<br>

Fritzing diagram: [docs/breadboard/kinect-arm-controller.fzz](breadboard/kinect-arm-controller.fzz)
...
![docs/images/robotic-arm.jpg](images/robotic-arm.jpg)  
...
![docs/images/arm-diagram.jpg](images/arm-diagram.jpg)  
...
- [JavaScript: Kinect Controlled Robot Arm](http://bocoup.com/weblog/javascript-arduino-kinect-robot-arm/)

- [LynxMotion: AL5D Robotic Arm](http://www.lynxmotion.com/c-130-al5d.aspx)
...
Copyright (c) 2015-2026 The Johnny-Five Contributors
Licensed under the MIT license.
